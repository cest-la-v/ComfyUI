...
class HiddenHolder:
    def __init__(self, unique_id: str, prompt: Any,
                 ...
                 generation_metadata: Any = None, **kwargs):
        ...
        """GENERATION_METADATA is a GenerationMetadata object with resolved generation parameters propagated through the graph."""
    ...
    def from_dict(cls, d: dict | None):
        ...
        return cls(
            ...
            generation_metadata=d.get(Hidden.generation_metadata, None),
        )
...
class Hidden(str, Enum):
    ...
    """GENERATION_METADATA is a GenerationMetadata object accumulating resolved generation parameters (prompts, model, sampler, etc.) propagated forward through the graph. Consumed by SaveImage to write an A1111-compatible parameters PNG chunk."""
